  ...
  function setCrewBox(crew) {
    ...
    return (
      <div className='castBoxDetails' key={crew.id}>
        ...
        <img className="castPoster"
          src={crew.profile_path ? `https://image.tmdb.org/t/p/w300${crew.profile_path}` : "https://user-images.githubusercontent.com/10515204/56117400-9a911800-5f85-11e9-878b-3f998609a6c8.jpg"}
          alt="Movie Poster" /> <br />
      ...
      {content && (
        ...
        <div className='pageBox'  >
          ...
          <div className='cardOfBox'>
            ...
            <div>
          {  (content.budget) ? (<h3 className='budgetRevenue'> Budget : {convertRupees(content.budget)}</h3>):""}
          {  (content.budget) ? ( <h3 className='budgetRevenue'> Revenue : {convertRupees(content.revenue)}</h3> ):""}
            </div>
